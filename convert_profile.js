const fs = require('fs');
let html = fs.readFileSync('C:/Users/PC/.gemini/antigravity-ide/brain/d4cc5e26-970e-41cd-b3b5-83153136acdd/scratch/profile.html', 'utf8');
...
`;
if(!fs.existsSync('f:/AnimeX/src/app/profile')) fs.mkdirSync('f:/AnimeX/src/app/profile');
fs.writeFileSync('f:/AnimeX/src/app/profile/page.tsx', jsx);
console.log('Done converting profile page!');
